...
def test_continuity_kernel_docs_exist() -> None:
    required_docs = {
    ...
    assert not missing, f"Missing required continuity docs: {missing}"


def test_canonical_source_of_truth_files_exist() -> None:
    required_files = {
    ...
    assert not missing, f"Missing canonical continuity files: {missing}"


def test_no_duplicate_package_catalog_or_map_files_in_core() -> None:
    allowed = {
        "backend/app/core/package_catalog.py",
        "backend/app/core/package_mapping.py",
        "backend/app/core/package_type_catalog.py",
...
def test_no_duplicate_role_catalog_or_map_files_in_core() -> None:
...
def test_no_duplicate_entitlement_service_files() -> None:
    allowed = {
        "backend/app/services/entitlement_service.py",
        "backend/app/services/project_entitlement_service.py",
...
def test_no_duplicate_viewer_public_manifest_service_files() -> None:
    allowed = {
        "backend/app/services/viewer_manifest_service.py",
        "backend/app/services/public_manifest_service.py",
    }
...
def test_viewer_and_public_manifest_services_are_separate_files() -> None:
...
def test_repair_scripts_require_dry_run_or_apply_safety_pattern() -> None:
...
def test_architecture_doc_contains_key_kernel_sections() -> None:
    ...
    assert not missing, f"Architecture doc is missing kernel sections: {missing}"
