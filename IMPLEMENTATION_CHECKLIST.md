...
Related blueprint: [PLATFORM_BLUEPRINT.md](./PLATFORM_BLUEPRINT.md)
Detailed on-chain backend reference: [ONCHAIN_ANCHOR_BACKEND_SPEC.md](./ONCHAIN_ANCHOR_BACKEND_SPEC.md)
